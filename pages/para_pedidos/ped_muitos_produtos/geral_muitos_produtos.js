export class GeralMuitosPrd {
    ...
    async saldodisponivel (selector) {
    ...
    async saldoCDDisponivel (selector) {
    ...
    async semSaldodisponivel (selector) {
    ...
    async escolherClientePedido2 (selector) {
    ...
    async botaoFinalizarPedido (selector) {
    ...
    async tirarEntregaSegundo (selector) {
    ...
    async tirarEntregaTerceiro (selector) {
    ...
    async tirarMontagemSegundo (selector) {
    ...
    async botaoGerarParcelas (selector) {
    ...
    async escolherFormaPagamentoPrincipal (selector) {
    ...
    async escolherDuasParcelaPagamento (selector) {
    ...
    async processoVendaPrincipal (selector) {
    ...
    async avancarParaParcelas (selector) {
    ...
    async avancarParaTransportadora (selector) {
    ...
    //Botão para avançar para a tela de Gerar parcelas - com intercept
    async avancarParcelasEntrega (selector) {
    ...
    async modalServicosVinculados (selector) {
    ...
    async escolherVoltagemProduto (selector) {
