...
import { prdPromoPrazoParcelaPrest, escolherRecebPromoPrazoFuturoComJurosPrest, escolherRecebPromoPrazoFuturoSemJurosPrest, 
         prdSegPromoPrazoParcelaPrest, prdPromoPartidaPrest, escolherRecebPromoPartidaPresentePrest } from '../../../support/para_pedidos_NFe/NFe_prd_promo_prestamista.js';
...
describe('Gerar pedidos com serviço Prestamista', () => {
    ...
    context('Sem entrega / Misto com e sem Promoção - Prestamista abatimento %', () => {
        ...
        it.only('13. Ped venda: produto 1918 0 0 (promoç a prazo 167) e 1860 0 0 (sem promoção), processo de inclusão 3874, prestamista 158, 4 parcelas no recebimento Futuro com juros.', () => {
