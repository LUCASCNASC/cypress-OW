...
export function prdPrimeiroEntregaFutNFe (selector) {
...
export function clicarVoltPrdPrimeiroEntregaFutNFe (selector) {
...
export function addPrdPrimeiroEntregaFutNFe (selector) {

    cy.intercept('GET', '/services/v3/produto_servico_vinculado?sku=1860.0.0&valor=1313&quantidade=1&processo=9862').as('api_servicos_vinculados')
...
export function prdSegundoEntregaFutNFe (selector) {
...
//Clicar para selecionar a voltagem que queremos adicionar ao pedido
export function clicarVoltPrdSegundoEntregaFutNFe (selector) {
...
//Botão adicionar produto após selecionar voltagem do produto
export function addPrdSegundoEntregaFutNFe (selector) {

    cy.intercept('GET', '/services/v3/produto_servico_vinculado?sku=1870.0.0&valor=1300&quantidade=1&processo=9862').as('api_servicos_vinculados')
