...
export function prdSegPromoPrazoParcelaPrest (selector) {
    ...
    cy.intercept('GET', '/consultaprodutos/10050/10006%20OR%2010050%20OR%2010102%20OR%2010032%20OR%2010048/(servico:false%20OR%20(servico:true%20AND%20processos:*9860*))%20AND%20((codigo:*1919*%20OR%20codigo:1919%20OR%20nome:*1919*%20OR%20nomeecommerce:*1919*%20OR%20marca_descricao:*1919))%20AND%20valor_filial_10050:%5B0%20TO%20*%5D/ativo:true/max(termfreq(filiais_com_saldo,10006),termfreq(filiais_com_saldo,10050),termfreq(filiais_com_saldo,10102),termfreq(filiais_com_saldo,10032),termfreq(filiais_com_saldo,10048))%20DESC,max(termfreq(filiais_com_promocao,10006),termfreq(filiais_com_promocao,10050),termfreq(filiais_com_promocao,10102),termfreq(filiais_com_promocao,10032),termfreq(filiais_com_promocao,10048))%20DESC,score%20DESC,valor_filial_10050%20ASC/50/0').as('apiConsultaProdutos')
...
export function escolherPesqSegPrdPromoPrazoParcelaPrest (selector) {
    ...
    cy.intercept('GET', '/services/v3/produto_tambem_compraram?lista=1919').as('api_produto_tambem_compraram_1919')
    ...
    cy.wait('@api_produto_tambem_compraram_1919', { timeout: 40000 })
}
