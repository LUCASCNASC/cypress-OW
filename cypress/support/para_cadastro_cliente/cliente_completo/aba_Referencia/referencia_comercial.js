...
//--------REFERENCIAS - REFERENCIA COMERCIAL -------

//validar e clicar na aba Comercial, dentro de Referencias
export function clicarAbaRefComercial (selector) {
...
export function validarAbaRefComercialVazia (selector) {
...
export function clicarAddNovaRefComercial (selector) {
...
export function modalRefComercialVazio (selector) {
...
export function messRefComercialIncluidaSucesso (selector) {
...
export function infosRefComercialAdicionada (selector) {
